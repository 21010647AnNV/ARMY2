...
public class BulletManager {
    ...
    public ArrayList<AddBOSS> addbos;
        ...
        for (int k = 0; k < nshoot; k++) {
            switch (bull) {
                ...
                case 0:
                    ...
                    entrys.add(new Bullet(this, (byte) 0, (pl.isUsePow ? 840 : (nshoot == 2 ? 210 : 420)), pl, x, y, vx, vy, 80, 100));
                    break;
                ...
                case 1:
                    ...
                    for (int i = 0; i < nBull; i++) {
                        entrys.add(new Bullet(this, (byte) 1, nshoot == 2 ? 109 : 210, pl, x, y, vx, vy, 50, 50));
                    }
                    break;
                ...
                case 2:
                    ...
                    for (int i = 0; i < nBulls; i++) {
                        ...
                        entrys.add(new Bullet(this, (byte) 2, nshoot == 2 ? 75 : 140, pl, x, y, vx, vy, 80, 60));
                        if (i == 0 || i == 4) {
                            continue;
                        }
                        arg = angle - i * 5;
                ...
                case 9:
                    ...
                    for (int i = 0; i < 4; i++, arg2 += 4) {
                        ...
                        entrys.add(new Bullet(this, (byte) 9, pl.isUsePow ? 212 : (nshoot == 2 ? 79 : 106), pl, x, y, vx, vy, 40, 90));
                    }
                    break;
                ...
                case 10:
                    ...
                    for (int i = 0; i < 3; i++) {
                        entrys.add(new Bullet(this, (byte) 10, pl.isUsePow ? 280 : (nshoot == 2 ? 80 : 140), pl, x, y, vx, vy, 50, 80));
                    }
                    break;
                ...
                case 11:
                    ...
                    for (int i = 0; i < 5; i++) {
                        entrys.add(new Bullet(this, (byte) 11, pl.isUsePow ? 168 : (nshoot == 2 ? 47 : 84), pl, x, y, vx, vy, 30, 90));
                    }
                    break;
                ...
                case 17:
                    ...
                    entrys.add(new ApaBullet(this, (byte) 17, pl.isUsePow ? 214 : (nshoot == 2 ? 81 : 107), pl, x, y, vx, vy, 30, 100, force, force2));
                    break;
                ...
                case 19:
                    ...
                    entrys.add(new ChickyBullet(this, (byte) 19, pl.isUsePow ? 450 : (nshoot == 2 ? 169 : 225), pl, x, y, vx, vy, 20, 50, force2));
                    break;
                ...
                case 21:
                    ...
                    entrys.add(new TazranBullet(this, (byte) 21, pl.isUsePow ? 840 : (nshoot == 2 ? 225 : 420), pl, x, y, vx, vy, 10, 50));
                    break;
                ...
                case 33:
                    ...
                    for (int i = 0; i < 5; i++) {
                        entrys.add(new Bullet(this, (byte) 33, 100, pl, x, y, vx, vy, 50, 80));
                    }
                    break;
                ...
                //T-rex or Robot dance
                case 35:
                    if (idGun != 15 && idGun != 14) {
                        return;
                    }
                    entrys.add(new Jump(this, (byte) 35, 5000, pl));
                    break;
                ...
                case 37:
                    ...
                    entrys.add(new BigRocKet(this, (byte) 37, 4700, pl));
                    break;
                ...
                case 40:
                    ...
                    entrys.add(new Bullet(this, (byte) 40, 4200, pl, x - 20, y - 20, vx, vy, 10, 80));
                    break;
                ...
                case 41:
                    ...
                    entrys.add(new Bullet(this, (byte) 41, 5000, pl, x - 20, y - 20, vx, vy, 10, 80));
                    break;
                ...
                case 42:
                    ...
                    entrys.add(new Bullet(this, (byte) 42, 35000, pl, pl.X, pl.Y, vx, vy + 10, 10, 0));
                    break;
                ...
                case 43:
                    ...
                    for (byte i = 0; i < 10; i++) {
                        ...
                        entrys.add(new Bullet(this, (byte) 43, 1000, pl, x, (short) (y + 50), vx, vy, 0, 100));
                    }
                    break;
                ...
                case 44:
                    ...
                    for (int i = 0; i < 15; i++) {
                        ...
                        entrys.add(new Bullet(this, (byte) 44, 1000, pl, x + 51, y + 40, vx + vxrd, vy, 40, 40));
                    }
                    break;
                ...
                case 45:
                    ...
                    entrys.add(new BalloonLazer(this, (byte) 45, 1000, pl, x + 65, y - 27));
                    break;
                ...
                case 49:
                    ...
                    if (ServerManager.mgtBullNew) {
                        entrys.add(new MGTBulletNew(this, (byte) 49, pl.isUsePow ? 840 : (nshoot == 2 ? 308 : 420), pl, x, y, vx, vy, 40, 70, force));
                    } else {
                        vx = (1600 * Until.cos(angle) >> 10);
                        vy = -(1600 * Until.sin(angle) >> 10);
                        entrys.add(new MGTBulletOld(this, (byte) 59, pl.isUsePow ? 820 : (nshoot == 2 ? 308 : 410), pl, x, y, vx, vy, force));
                    }
                    break;
    ...
    public void fillXY() throws IOException {
        boolean hasNext;
        do {
            hasNext = false;
