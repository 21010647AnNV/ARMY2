...
import army2.fight.boss.BoxGift;
...
public class FightManager {
    ...
    protected final byte timeCountMax = 31;
    ...
    private void nextBoss() throws IOException {
        //Map Bom 1
        if (this.wait.map == 30) {
            //map bom 1 bat sieu boss thi cho nhieu boss
            //Bom
             if (this.wait.isSiuBoss) {      
             byte numBoss = (new byte[]{2, 2, 4, 4, 6, 7, 7, 8, 8})[playerCount];
            for (byte i = 0; i < numBoss; i++) {
                ...
                players[allCount] = new BigBoom(this, (byte) 12, "BigBoom", (byte) allCount, 2500 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
             }
               //Map KV cam
        if (this.wait.isSiuBoss) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                ...
                players[allCount] = new UFO(this, (byte) 16, "UFO", (byte) allCount, 1500 + (this.getLevelTeam() * 20), X, Y);
                allCount++;
            
        }
    
            } else {
            byte numBoss = (new byte[]{6, 6, 7, 7, 8, 9, 9, 10, 10})[playerCount];
            for (byte i = 0; i < numBoss; i++) {
                short X = (short) ((i % 2 == 0) ? Until.nextInt(95, 315) : Until.nextInt(890, 1070));
                short Y = (short) (50 + 40 * Until.nextInt(3));
                players[allCount] = new BigBoom(this, (byte) 12, "BigBoom", (byte) allCount, 3500 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
            }
        }
        ...
        if (this.wait.map == 31) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                ...
                short Y = 180;
                players[allCount] = new BigBoom(this, (byte) 12, "SmallBoom", (byte) allCount, 1000 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
        }
        //map nhen may
        if (this.wait.map == 32) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                players[allCount] = new SpiderMachine(this, (byte) 13, "Spider Robot", (byte) allCount, 2000 + (getLevelTeam() * 15), (short) tempX[i], (short) tempY[i]);
                allCount++;
            }
        }
        //map thanh pho may
        if (this.wait.map == 33) {
            ...
            for (int i = 0; i < numBoss; i++) {
                short X = tempX[i];
                short Y = (short) 200;
                players[allCount] = new Robot(this, (byte) 14, "Robot", (byte) allCount, 2000 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
        }
        //Map T-rex Máy
        if (this.wait.map == 34) {
            ...
            short X = 880;
            short Y = 400;
            players[allCount] = new Trex(this, (byte) 15, "T-rex", (byte) allCount, 30000 + (this.getLevelTeam() * 10), X, Y);
            allCount++;
            byte numBoss = (new byte[]{4, 4, 5, 5, 6, 6, 7, 7, 8})[playerCount];
            for (byte i = 0; i < numBoss; i++) {
                X = (short) (Until.nextInt(470, 755));
                Y = 400;
            players[allCount] = new Ghost(this, (byte) 25, "Ghost", (byte) allCount, 10 + (this.getLevelTeam() * 10), X, Y);
            allCount++;
            }
        }
        ...
        if (this.wait.map == 35) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                short X = (short) (Until.nextInt(300, 800));
                short Y = (short) Until.nextInt(-350, 100);
                players[allCount] = new UFO(this, (byte) 16, "UFO", (byte) allCount, 7000 + (this.getLevelTeam() * 20), X, Y);
                allCount++;
            }
        }
        //Map HMLS
        if (this.wait.map == 36) {
            short X = (short) (Until.nextInt(300, 800));
            short Y = (short) Until.nextInt(-350, 100);
            players[allCount] = new Balloon(this, (byte) 17, "Balloon", (byte) allCount, 7777, X, Y);
            allCount++;
            players[allCount] = new Balloon_Gun(this, (byte) 18, "Balloon Gun", (byte) allCount, 10000 + (this.getLevelTeam() * 10), (short) (X + 51), (short) (Y + 19));
            allCount++;
            players[allCount] = new Balloon_GunBig(this, (byte) 19, "Balloon Gun Big", (byte) allCount, 9500 + (this.getLevelTeam() * 10), (short) (X - 5), (short) (Y + 30));
            allCount++;
            players[allCount] = new Balloon_FanBack(this, (byte) 20, "Fan Back", (byte) allCount, 1500 + (this.getLevelTeam() * 10), (short) (X - 67), (short) (Y - 6));
            allCount++;
        }
        ...
        if (this.wait.map == 37) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                ...
                short Y = (short) 250;
                players[allCount] = new SpiderPoisonous(this, (byte) 22, "Spider Poisonous", (byte) allCount, 5500 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
        }
        ...
        if (this.wait.map == 38) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                ...
                players[allCount] = new Ghost(this, (byte) 25, "Ghost", (byte) allCount, 1200 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
        }
        ...
        if (this.wait.map == 39) {
            ...
            for (byte i = 0; i < numBoss; i++) {
                ...
                short Y = (short) Until.nextInt(30);
                players[allCount] = new Ghost2(this, (byte) 26, "Ghost II", (byte) allCount, 1500 + (this.getLevelTeam() * 10), X, Y);
                allCount++;
            }
        }
    ...
    public void nextTurn() throws IOException {
        ...
        if (nTurn > 1 && this.nHopQua > 0 && Until.nextInt(2) == 0) {
            short x,y;
            x = (short) Until.nextInt(20, this.mapMNG.Width -20);
            y = (short) Until.nextInt(-100, 100);
            this.addBoss(new BoxGift(this, (byte)24, "Box Gift", (byte) allCount, 1, x, y));
            this.nHopQua--;
        }
        this.nTurn++;
        // Update XY Player
        ...
        if (this.bullMNG.addbos.size() > 0) {
            for (byte i = 0; i < this.bullMNG.addbos.size(); i++) {
                BulletManager.AddBOSS bos = this.bullMNG.addbos.get(i);
                this.addBoss(bos.players);
                players[allCount - 1].XPExist = bos.XPE;
            }
            this.bullMNG.addbos.clear();
        }
        ...
        if (this.isBossTurn) {
            ...
            Player pl = this.players[this.playerTurn];
            // meu la guner pem chung tang st
            if (pl.idNV == 0 && pl.noiTai[0] > 0) {
                pl.noiTai[1] += 5 + pl.us.getLevel() / 2;
                //toi da st tang la 1k
                if (pl.noiTai[1] > 1000) {
                    pl.noiTai[1] = 1000;
                }
            }
            // neu là proton den luot +4% hp
            if (pl.idNV == 2) {
                pl.updateHP(pl.HPMax * 4/ 100);
            }
            // neu là rocket den luot +5+LV/2 hp
            if (pl.idNV == 4) {
                pl.updateHP(5 + pl.us.getLevel() / 2);
            }
            //neu la MGT duoi 40% HP vo hinh toi khi den luot mik
            if (pl.idNV == 9 && (pl.HP * 100) / pl.HPMax < 40 && pl.noiTai[0] == 0) {
                pl.voHinhCount++;
                pl.noiTai[0]++;
            }
        }
        for (byte i = 0; i < ServerManager.maxPlayers; i++) {
            ...
            if (pl.idNV == 1 && pl.noiTai[0] > 0) {
                pl.noiTai[2]++;
                if (pl.noiTai[2] == 3) {
                    pl.noiTai[2] = 0;
                    pl.updateHP(pl.noiTai[1] * 10 / 100);
                }
                //so lan ban trung rest vè = 0
                pl.noiTai[1] = 0;
                pl.noiTai[0] = 0;
            }
            if (pl.idNV == 8 && pl.noiTai[0] > 0) {
                pl.updateHP((50 + (pl.HPMax * 30 / 100)) * pl.noiTai[0]);
                pl.noiTai[0] = 0;
            }
        }
        this.nextHP();
    ...
    public boolean checkWin() throws IOException {
        ...
        if (FightManager.this.type == 5) {
            ...
            while (i < ServerManager.maxPlayers) {
                ...
                if (pl2 != null && !pl2.isDie && pl2.idNV != 23 && pl2.idNV != 24) {
                    nPlayerAlive++;
                }
                i++;
            }
    ...
    private void fightComplete(byte checkWin) throws IOException {
        ...
        if (nTurn < 3) {
            ms = new Message(45);
            ds = ms.writer();
            ds.writeUTF(GameString.notCompletedMatch());
            ds.flush();
            this.sendToTeam(ms);
        } else if (!this.wait.isLH && !wait.isSiuBoss && this.type == 5 && checkWin == 1) {
            for (byte i = 0; i < ServerManager.maxPlayers; i++) {
                Player pl = this.players[i];
                if (pl == null || pl.us == null) {
                    continue;
                ...
                int numSpItem = Until.nextInt(0, 20);
                ...
                String strItem = numItem + "x " + ItemData.entrys.get(idItem).name + " " + numSpItem + "x " + SpecialItemData.getSpecialItemById(idSpItem).name;
            ...
            if (wait.type == 5 && checkWin == 1) {
                for (byte i = 0; i < ServerManager.maxPlayers; i++) {
                    Player pl = this.players[i];
                    if (pl == null || pl.us == null) {
                        continue;
                    }
                    byte arid = new byte[]{90,79,80,81,82,83}[Until.nextInt(4)];
                    byte numSpItem = (byte) Until.nextInt(1, 3);
                    pl.us.updateSpecialItem(arid, numSpItem);
                    pl.us.sendMSSToUser(null, "Bạn nhận được "+numSpItem+"x "+SpecialItemData.getSpecialItemById(arid).name);
            ...
            String nameTeam = "";
            byte num = 0;
            byte numRHB = (byte) Until.nextInt(1, 2);
            for (int i = 0; i < ServerManager.maxPlayers; i++) {
                Player pl = this.players[i];
                if (pl == null || pl.us == null)
                    continue;
                int xpup = Until.nextInt(10, 50) * 100;
                pl.us.sendMSSToUser(null, "Trận đấu hoàn thành phần quà của bạn là "+ Until.getStrungNum(xpup) +"XP");
                pl.us.updateXP(xpup, false);
                pl.us.updateSpecialItem(74, numRHB);
                XPTeam += pl.AllXPUp;
                nameTeam += num > 0 ? (", "+pl.us.getUserName()) : (" "+pl.us.getUserName());
                num++;
            }
            ms = new Message(46);
            ds = ms.writer();
            ds.writeUTF("Chúc mừng"+ nameTeam +" đã hoàn thành trận đấu phần thưởng là "+Until.getStrungNum(XPTeam)+" XP và "+ numRHB +" Rương");
            ds.flush();
            ServerManager.sendToServer(ms);
             ...
             /*  byte win = (byte) (pl.team ? checkWin : -checkWin);
                if (win == 1) {
                    pl.us.updateEventScore(1000);
                    ms = new Message(45);
                    ds = ms.writer();
                    ds.writeUTF("Bạn nhận được 1000 điểm sự kiện!");
                    ds.flush();
                    pl.us.sendMessage(ms);
                }*/
                    
        } else if (wait.isSiuBoss && checkWin == 1) {
            int XPTeam = 0;
            String nameTeam = "";
            byte num = 0;
            byte numRHB = (byte) Until.nextInt(1, 2);
            for (int i = 0; i < ServerManager.maxPlayers; i++) {
                ...
                if (pl == null || pl.us == null)
                    continue;
                int xpup = Until.nextInt(10, 50) * 300;
                pl.us.sendMSSToUser(null, "Siêu boss hoàn thành phần quà của bạn là "+ Until.getStrungNum(xpup) +"XP");
                pl.us.updateXP(xpup, false);
                pl.us.updateSpecialItem(74, numRHB);
                XPTeam += pl.AllXPUp;
                nameTeam += num > 0 ? (", "+pl.us.getUserName()) : (" "+pl.us.getUserName());
            ...
            ms = new Message(46);
            ds = ms.writer();
            ds.writeUTF("Chúc mừng"+ nameTeam +" đã hoàn thành siêu boss phần thưởng là "+Until.getStrungNum(XPTeam)+"XP và "+ numRHB +"hòm Rương huyền bí");
            ds.flush();
            ServerManager.sendToServer(ms);
            
        }  if (wait.map == 34 && checkWin == 1) {
            int XPTeam = 0;
            String nameTeam = "";
            byte num = 0;
            byte numRHB = (byte) Until.nextInt(1, 8);
            for (int i = 0; i < ServerManager.maxPlayers; i++) {
                Player pl = this.players[i];
                if (pl == null || pl.us == null)
                    continue;
                int xpup = Until.nextInt(50,90) * 500;
                pl.us.sendMSSToUser(null, "Siêu T-Rex hoàn thành phần quà của bạn là "+ Until.getStrungNum(xpup) +"XP");
                pl.us.updateXP(xpup, false);
                pl.us.updateSpecialItem(74, numRHB);
                XPTeam += pl.AllXPUp;
                nameTeam += num > 0 ? (", "+pl.us.getUserName()) : (" "+pl.us.getUserName());
            ...
            ms = new Message(46);
            ds = ms.writer();
            ds.writeUTF("Chúc mừng"+ nameTeam +" đã hoàn thành phòng kinh nghiệm phần thưởng là "+Until.getStrungNum(XPTeam)+"XP và "+ numRHB +"hòm Rương huyền bí");
            ds.flush();
            ServerManager.sendToServer(ms);
        }
       /* if (!wait.isLH && checkWin == 1) {
            for (byte i = 0; i < ServerManager.maxPlayers; i++) {
                Player pl = players[i];
                if (pl == null || pl.us == null) {
                    continue;
                }
                byte numbnlsk = (byte) (wait.isLH ? Until.nextInt(5, 10) : Until.nextInt(1, 15));
                byte arid = new byte[]{74,79,80,81,82,83}[Until.nextInt(4)];
                pl.us.updateSpecialItem(arid, numbnlsk);
              
        pl.us.sendMSSToUser(null, "+" + numbnlsk + "x " + SpecialItemData.getSpecialItemById(arid).name);
...
//Top điểm
        ...
        */
        ...
        /* if (!wait.isLH && checkWin == 1 && (39 == this.mapMNG.Id || this.mapMNG.Id == 38)) {
            for (byte i = 0; i < ServerManager.maxPlayers; i++) {
                Player pl = players[i];
                if (pl == null || pl.us == null) {
                    continue;
                }
                byte numbingo = (byte) Until.nextInt(0, 2);
                byte numlhai = (byte) Until.nextInt(0, 2);
                if (numbingo > 0 && mapMNG.Id == 38) {
                    pl.us.updateSpecialItem(77, numbingo);
                    pl.us.sendMSSToUser(null, "+" + numbingo + "x Bí ngô");
                }
                if (numlhai > 0 && mapMNG.Id == 39) {
                    pl.us.updateSpecialItem(78, numlhai);
                    pl.us.sendMSSToUser(null, "+" + numlhai + "x Lưới hái");
                }
            }
        }*/
        ...
        for (byte i = 0; i < ServerManager.maxPlayers; i++) {
            ...
            ds.writeInt(pl.us.getLevel() * (pl.us.getLevel() + 1) * 5000);
            ds.writeByte(0);
        ...
        if (wait.isLH) {
            for (byte i = 0; i < ServerManager.maxPlayers; i++) {
                ...
                String strItem = "";
                int[] arXP = new int[]{0, 1000, 2000, 2500, 3000, 3500, 4000, 5000, 50000};
                int[] arXu = new int[]{0, 1000, 5000, 10000, 20000, 50000, 100000, 200000, 300000};
                if (LHfinish) {
                    byte xXu = (byte) Until.nextInt(1, 10);
                    pl.us.sendMSSToUser(null, String.format(GameString.LHFinish(), Until.getStrungNum(arXP[arXP.length - 1] * xXu) + " XP +" + Until.getStrungNum(arXu[arXu.length - 1]) + " Xu"));
                    pl.us.updateXP(arXP[arXP.length - 1], false);
                    pl.us.updateXu(arXu[arXu.length - 1] * xXu);
                    byte numbingo = (byte) Until.nextInt(1, 10);
                  //  byte numlhai = (byte) Until.nextInt(2, 5);
                    pl.us.updateSpecialItem(74, numbingo);
                   // pl.us.updateSpecialItem(78, numlhai);
                    pl.us.sendMSSToUser(null, "+" + numbingo + " Rưong huyền bí");
                     
                } else if (LHSuccess) {
                    strItem = Until.getStrungNum(arXP[wait.ntLH]) + " XP +" + Until.getStrungNum(arXu[wait.ntLH]) + " Xu";
    ...
    protected void startGame(int nTeamPointBlue, int nTeamPointRed) throws IOException {
        ...
        if (this.ltap) {
            ...
            if (this.type < 3) {
                this.nHopQua = (byte) this.playerCount;
            }
    ...
    public void shootMessage(User us, Message ms) throws IOException {
        ...
        this.newShoot(index, bullId, (arg > 360 ? 360 : (arg < -360 ? -360 : arg)), (force > 30 ? 30 : (force < 0 ? 0 : force)), (force2 > 30 ? 30 : (force2 < 0 ? 0 : force2)), nshoot, ltap);
    }
    ...
    public void ghostBlowingWind(int index, int toIndex) throws IOException {
    ...
    public void setXY(byte index) throws IOException {
    ...
    public void moveToPlayer(byte index) throws IOException {
    ...
    private void nextGift() throws IOException {
        for (int i = 0; i < ServerManager.maxPlayers; i++) {
            ...
            if (pl == null || pl.us == null)
                continue;
            for (int j = 0; j < pl.boxGift.size(); j ++){
                Player.box nb = pl.boxGift.get(0);
