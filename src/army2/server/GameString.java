...
public class GameString {
   ...
   public static String newsNoti() {
     return "Mọi người chơi game điều độ, giữ gìn sức khoẻ!";
  }
    ...
    public static String loginPassFail() {
        return "Tài khoản hoặc mật khẩu không đúng. Hoặc đăng kí lại tại army2.pw";
    }
    ...
    protected static String notClan() {
